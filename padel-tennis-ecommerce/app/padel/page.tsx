...
const subcategories = ["palas", "zapatillas", "pelotas", "bolsos", "ropa", "accesorios"]
...
export default function PadelPage() {
  ...
  const filterProducts = async () => {
    ...
    if (searchQuery.trim()) {
      ...
      filtered = searchResults.filter((product) => product.category === "padel")
    } else {
      // Filtro por subcategoría
      if (selectedSubcategory !== "all") {
        const subcategoryResults = await getProductsBySubcategory("padel", selectedSubcategory)
