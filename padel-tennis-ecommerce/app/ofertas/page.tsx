...
import { Search, MessageCircle, Heart, Share2, Menu, X, ArrowRight } from "lucide-react";
...
const brandLogos: { [key: string]: { src: string, alt: string, width: number, height: number } } = {
  ...
  "Bullpadel": { src: "/optimized/bullpadel-logo.webp", alt: "Bullpadel Logo", width: 90, height: 40 },
};
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  {/* Category Badge */}
                  <div className="text-center">
                    <Badge variant="secondary" className="bg-red-100 text-red-800 font-medium text-sm px-4 py-2">
                      {subcategoryNames[selectedProduct.subcategory] || selectedProduct.subcategory} • {selectedProduct.category === "padel" ? "Padel" : selectedProduct.category === "tenis-mesa" ? "Tenis de Mesa" : "Tenis"}
                    </Badge>
                  </div>
                </div>
